    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instruments.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent InstrumentsIntent = new Intent(SearchActivity.this, InstrumentsActivity.class);
        ...
        levels.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link NumbersActivity}
                Intent LevelsIntent = new Intent(SearchActivity.this, LevelsActivity.class);
        ...
        playingNow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Create a new intent to open the {@link NumbersActivity}
                Intent PlayingNowIntent = new Intent(SearchActivity.this, PlayingNowActivity.class);
